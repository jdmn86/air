...
public class MasterTest {
    ...
    protected void setMobileData(boolean enabled) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        final Class iConnectivityClass = Class.forName(iConnectivityManager.getClass().getName());
        final Method setMobileDataEnabledMethod = iConnectivityClass.getDeclaredMethod("setMobileDataEnabled", Boolean.TYPE);
