...
public class US5_AT6 {
    ...
    public void uS5_AT6() {
        ...
        ViewInteraction imageView = onView(
                allOf(withId(R.id.imageView_alarm_type), withContentDescription("desc for alarm"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView_alarmsData_Date), withText("02/12/2017 00:01"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
                                        0),
                                0),
                        isDisplayed()));
        textView.check(matches(withText("02/12/2017 00:01")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.textView_alarms_description_data), withText("hgcghjcjgh"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
                                        1),
                                1),
                        isDisplayed()));
        textView2.check(matches(withText("hgcghjcjgh")));
